...
import com.example.ajinhedrou.login.OnButtonSwitchedListener;
...
public class LoginButton extends View {
    ...
    public OnSignUpListener onSignUpListener;
    ...
    private void init() {
        ...
        signUpButtonPaint.setColor(ContextCompat.getColor(getContext(), R.color.btn));
        ...
        loginPaint.setColor(ContextCompat.getColor(getContext(), R.color.btn));
        loginPaint.setTextAlign(CENTER);
        loginPaint.setTextSize(dpToPixels(16));

        orPaint = new Paint();
        orPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorAccent));
        orPaint.setTextSize(dpToPixels(16));

        signUpPaint = new Paint();
        signUpPaint.setColor(ContextCompat.getColor(getContext(), R.color.colorAccent));
...
//        signUpPaint.setAlpha(255);
    ...
    public void startAnimation() {
        final float start = getStartButtonRight();
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (isLogin) {
                    ...
                    currentLoginY = startLoginY - ((startLoginY - LoginButton.this.dpToPixels(457)) * fraction);
                    ...
                    currentSignUpTextY = startSignUpTextY - ((startSignUpTextY - LoginButton.this.dpToPixels(457)) * fraction);
                    signUpPaint.setTextSize(smallTextSize + ((largeTextSize - smallTextSize) * (fraction)));
                }

                currentArcY = (int) (fraction * LoginButton.this.dpToPixels(28)); // just hardcoded value
                currentArcX = (int) (fraction * LoginButton.this.dpToPixels(37)); // just hardcoded value
                ...
                if (currentBottomY == height) {
                    double cot = 1.0f / tan(currentAngle);
                    currentBottomX = (float) ((y - LoginButton.this.getBottomMargin()) * cot);
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                final float hiddenButtonLeft = currentLeft;
                final float hiddenButtonRight = currentRight;
                final float endSignUpOrX = signUpOrX;
                final float endSignUpTextX = currentSignUpTextX;
                final float endLoginOrX = loginOrX;
                final float endLoginTextX = currentLoginX;
                ...
                buttonBounce.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                    @Override
